...
public class CompletedInstancesPanel extends DetailPanel {
  ...
  public CompletedInstancesPanel() {
  ...
  protected void initPageTitle() {
    ...
    Label groupName = new Label("Process definitions of completed instances");
  ...
  protected void initDefinitionTitle(HorizontalLayout membersHeader) {
    Label usersHeader = new Label("Process definitions");
  ...
  protected void initDefinitionsTable() {
    if(instanceList == null || instanceList.size() == 0) {
    	noMembersTable = new Label("No completed process instances found");
      ...
      definitionsTable.addContainerProperty("id", String.class, null);
      definitionsTable.addContainerProperty("name", String.class, null);
      definitionsTable.addContainerProperty("nr of instances", String.class, null);
  ...
  protected void initInstancesTable() {
    ...
    instancesTable.addContainerProperty("business key", String.class, null);
    instancesTable.addContainerProperty("start user id", String.class, null);
    instancesTable.addContainerProperty("start activity id", String.class, null);
    instancesTable.addContainerProperty("start time", String.class, null);
    instancesTable.addContainerProperty("end time", String.class, null);
    instancesTable.addContainerProperty("duration", String.class, null);
  ...
  protected void addTasks(HistoricProcessInstance processInstance) {
  	if(tasksHeader == null) {
	  	...
	  	addDetailComponent(new Label("&nbsp;", Label.CONTENT_XHTML));
  	}
    
  	if(taskTable != null) {
  		mainPanel.removeComponent(taskTable);
  	} else if(noTasksLabel != null) {
    ...
    if(tasks.size() > 0) {
      ...
      addDetailComponent(noTaskLabel);
    }
  }
  ...
  protected void addVariables(HistoricProcessInstance processInstance) {
    ...
    if(variables.size() > 0) {
      ...
      variablesTable.addContainerProperty("type", String.class, null, "type", null, Table.ALIGN_LEFT);
