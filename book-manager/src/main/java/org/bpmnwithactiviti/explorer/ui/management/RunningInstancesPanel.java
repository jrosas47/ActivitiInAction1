...
public class RunningInstancesPanel extends DetailPanel {
  ...
  protected void initPageTitle() {
    ...
    Label groupName = new Label("Process definitions of running instances");
  ...
  protected void initDefinitionsTable() {
    if(instanceList == null || instanceList.size() == 0) {
    	noMembersTable = new Label("No running process instances found");
