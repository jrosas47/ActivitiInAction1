...
import org.bpmnwithactiviti.explorer.ui.management.BookManagementPage;
...
public class DefaultViewManager implements ViewManager {
  ...
  public void showBookManagementPage() {
    switchView(new BookManagementPage(), ViewManager.MAIN_NAVIGATION_MANAGE, ManagementMenuBar.ENTRY_BOOK_MANAGEMENT);
  }
  
  public void showBookManagementPage(String managementId) {
    switchView(new BookManagementPage(managementId), ViewManager.MAIN_NAVIGATION_MANAGE, ManagementMenuBar.ENTRY_BOOK_MANAGEMENT);
  }
