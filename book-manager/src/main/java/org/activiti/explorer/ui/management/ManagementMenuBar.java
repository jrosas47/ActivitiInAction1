...
public class ManagementMenuBar extends ToolBar {
  ...
  public static final String ENTRY_BOOK_MANAGEMENT = "administration";
  ...
  protected void addAdministrationToolbarEntry() {
    addToolbarEntry(ENTRY_BOOK_MANAGEMENT, i18nManager.getMessage(Messages.MGMT_MENU_ADMINISTRATION), new ToolbarCommand() {
      public void toolBarItemSelected() {
